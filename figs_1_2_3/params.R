...
BM.MODEL.PATH = file.path(MODEL.DIR, 'bm_metacell_atlas.h5ad')
...
CORRECTION.FACTOR.PATH = file.path(DATA.DIR, 'correction_factor')
BATCH.EFFECT.PVALS.PATH = file.path(DATA.DIR, 'batch_pvals')
