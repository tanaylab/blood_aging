...
fig1 <- function() {
  ...
  our.cdata = anndata::read_h5ad(file.path(MODEL.DIR, 'all_cells_fil3_cdata_output.h5ad'))
  our.mdata = anndata::read_h5ad(file.path(MODEL.DIR, 'all_cells_fil3_mdata_output.h5ad'))
...
bm.comparison <- function(our.mdata, our.annotation, fig.dir=file.path(BASE.FIG.DIR, 'fig1')) {
  ...
  pal.cdata = anndata::read_h5ad(file.path(MODEL.DIR, 'palantir_all_500000_cdata_output.h5ad'))
  pal.mdata = anndata::read_h5ad(file.path(MODEL.DIR, 'palantir_all_500000_mdata_output.h5ad'))
  pal.legc = t(log2(1e-5 + pal.mdata$X / rowSums(pal.mdata$X)))

  our.bm.mdata = anndata::read_h5ad(file.path(MODEL.DIR, 'our_bm_mdata.h5ad'))
...
bm.comparison.nktdp <- function(our.legc, fig.dir) {
  pbmc160.cdata = anndata::read_h5ad(file.path(MODEL.DIR, 'pbmc_160k_300000_cdata_output.h5ad'))
  pbmc160.mdata = anndata::read_h5ad(file.path(MODEL.DIR, 'pbmc_160k_300000_mdata_output.h5ad'))
  pbmc160.legc = t(log2(1e-5 + pbmc160.mdata$X / rowSums(pbmc160.mdata$X)))

  garvan.cdata = anndata::read_h5ad(file.path(MODEL.DIR, 'garvan_cdata_output.h5ad'))
  garvan.mdata = anndata::read_h5ad(file.path(MODEL.DIR, 'garvan_mdata_output.h5ad'))
...
mk.model.analysis <- function(fig.dir=file.path(BASE.FIG.DIR, 'fig1')) {
  mdata.output.all = anndata::read_h5ad(file.path(MODEL.DIR, 'all_cells3_mdata_output.h5ad'))
